...
webservice_appid = cf.get("webservice", "appid")
webservice_port = cf.getint("webservice", "port")

attachment_path = cf.get("base", "attachment_path")
illustrate_path = cf.get("base", "illustrate_path")
...
if __name__ == "__main__":
    ...
    app.run(host="0.0.0.0", port=webservice_port, debug=False)
